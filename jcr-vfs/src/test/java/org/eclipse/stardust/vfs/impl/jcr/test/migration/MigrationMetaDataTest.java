 ...
 *
 */
@Ignore("can only be executed manually since it requires a prepared jcr repository")
@SuppressWarnings("deprecation")
public class MigrationMetaDataTest implements IJackrabbitTest
{
   ...
   @ClassRule
   public static final JackrabbitTestClassSetup testClassSetup = new JackrabbitTestClassSetup("local-fs-repo.xml", "c:/tmp/migration-repo");
