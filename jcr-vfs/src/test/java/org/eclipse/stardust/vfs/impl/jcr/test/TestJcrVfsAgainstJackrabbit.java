 ...
 *******************************************************************************/
/*
 * $Id: TestJcrVfsAgainstJackrabbit.java 54136 2012-02-29 12:33:54Z sven.rottstock $
 ...
 */
public class TestJcrVfsAgainstJackrabbit extends AbstractJcrVfsTest
{
   ...
   private static Repository connect(URL url)
   {
      ...
      if (local)
      {
         ...
         String repHomeDir = "c:/tmp/jackrabbit/";
