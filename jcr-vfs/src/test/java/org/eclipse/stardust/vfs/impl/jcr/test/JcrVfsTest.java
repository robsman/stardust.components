...
import org.eclipse.stardust.vfs.impl.jcr.setup.test.IJackrabbitTest;
import org.eclipse.stardust.vfs.impl.jcr.setup.test.JackrabbitTestClassSetup;
import org.eclipse.stardust.vfs.impl.jcr.setup.test.JackrabbitTestMethodSetup;
...
public class JcrVfsTest implements IJackrabbitTest
{
   ...
   @ClassRule
   public static final JackrabbitTestClassSetup testClassSetup = new JackrabbitTestClassSetup("in-mem-repo.xml", null);

   @Rule
   public final JackrabbitTestMethodSetup testMethodSetup = new JackrabbitTestMethodSetup(this, testClassSetup);
   ...
   public void setJcrVfsWithAllPrivileges(IDocumentRepositoryService jcrVfsWithAllPrivileges)
   {
   ...
   public void setJcrVfsWithReadPrivileges(IDocumentRepositoryService jcrVfsWithReadPrivileges)
   {
   ...
   @Test
   public void test01Cleanup() throws Exception
   {
      try
      {
   ...
   @Test
   public void test02CreateFolder() throws Exception
   {
   ...
   @Test
   public void test03GetFolder() throws Exception
   {
   ...
   @Test
   public void test04UpdateFolder() throws Exception
   {
   ...
   @Test
   public void test05CreateFile() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test06CreateFileExistingContent() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test07MoveFileKeepMetadata() throws Exception
   {
   ...
   @Test
   public void test08MoveFileNewMetadata() throws Exception
   {
   ...
   @Test
   public void test09UpdateFileExistingContent() throws Exception
   {
      ...
      jcrVfsWithAllPrivileges.updateFile(originalFile, contentOriginFilePath, false, null, null,
            false);
   ...
   @Test
   public void test10GetFilledFolder() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test11GetFiles() throws Exception
   {
   ...
   public void test12FindFilesByName() throws Exception
   {
   ...
   @Test
   public void test13FindFiles() throws Exception
   {
   ...
   public void test14FindFilesByContent() throws Exception
   {
      ...
      String xPathQuery = "/jcr:root//element(*, nt:file) [jcr:contains(jcr:content, '%this Agreement%') and jcr:content/@jcr:mimeType eq 'text/plain']";

      int fileCount = jcrVfsWithAllPrivileges.findFiles(xPathQuery).size();
      ...
      for (int i=0; fileCount != expectedFileCount && i<retryCount; i++)
      {
         Thread.sleep(1000L);
         fileCount = jcrVfsWithAllPrivileges.findFiles(xPathQuery).size();
      }
      assertEquals(expectedFileCount, fileCount);
   }

   @Test
   public void test15RetrieveFileContent() throws Exception
   {
   ...
   @Test
   public void test16GetFolders() throws Exception
   {
   ...
   @Test
   public void test17FindFoldersByName() throws Exception
   {
   ...
   public void test18RenameFiles() throws Exception
   {
      ...
      jcrVfsWithAllPrivileges.updateFile(v0, false, null, null, false);
   ...
   @Test
   public void test19RenameFolders() throws Exception
   {
   ...
   @Test
   public void test20FindFolders() throws Exception
   {
   ...
   public void test21FileVersioning() throws Exception
   {
      ...
      IFile v1 = jcrVfsWithAllPrivileges.createFileVersion(v0.getPath(), null, "Nasen-Version",
            false);
      ...
      IFile v2 = jcrVfsWithAllPrivileges.createFileVersion(v1.getPath(), null, "Nasen-Version",
            true);
   ...
   @Test
   public void test22FileUpdateVersion() throws Exception
   {
...
//      v1 = jcrVfsWithAllPrivileges.updateFile(v1,"REALLY NEW CONTENT new content".getBytes(),null, true, false);
   ...
   public void test23LockFile() throws Exception
   {
   ...
   public void test24UnlockFile() throws Exception
   {
   ...
   @Test
   public void test25UpdateFile() throws Exception
   {
      IFile fHase = jcrVfsWithAllPrivileges.getFile("/nase/hase.txt");
      ...
      jcrVfsWithAllPrivileges.updateFile(fHase, false, null, null, false);
   ...
   @Test
   public void test26UpdateMetadata() throws Exception
   {
      ...
      fHase = jcrVfsWithAllPrivileges.updateFile(fHase, false, null, null, false);
      ...
      // Sr. No. 2 (wrt. prp2)
      fHase = jcrVfsWithAllPrivileges.updateFile(fHaseInitial, false, null, null, false);
   ...
   @Test
   public void test27Metadata() throws Exception
   {
   ...
   @Test
   public void test28Annotations() throws Exception
   {
      ...
      List<Integer> ints = (List<Integer>)fMetadata.getAnnotations().get("p1_list");
      assertEquals(intList.size(), ints.size());
      ...
      fMetadata = jcrVfsWithAllPrivileges.updateFile(fMetadata, false, null, null, false);
      ...
      fMetadata.setAnnotations(Collections.<String, Serializable>emptyMap());
   ...
   @Test
   public void test29PropertiesTypeAttributes() throws Exception
   {
   ...
   @Test
   public void test30UpdateFileVersion() throws Exception
   {
   ...
   @Test
   public void test31UpdateFileContent() throws Exception
   {
      IFile fHase = jcrVfsWithAllPrivileges.getFile("/nase/hase.txt");
      ...
      jcrVfsWithAllPrivileges.updateFile(fHase, fakeContent, null, false, null, null, false);
   ...
   @Test
   public void test32FolderPrivileges() throws Exception
   {
      // folder
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test33FilePrivileges() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test34GetFolderDefaultEffectivePolicies() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test35GetFolderDefaultPolicies() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test36AddFolderPolicy() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test37ChangeFolderPolicy() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test38FileInheritedPolicy() throws Exception
   {
   ...
   @Test
   public void test39RemoveFolderPolicy() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test40GroupPermissions() throws Exception
   {
   ...
   @Test
   public void test41SetAndUpdatePrivileges() throws Exception
   {
   ...
   public void test42Revert()
   {
      ...
      jcrVfsWithAllPrivileges.updateFile(v0, "update1".getBytes(), null, true, null, null, false);
      ...
      jcrVfsWithAllPrivileges.updateFile(v1, "update2".getBytes(), null, true, null, null,
            false);
      ...
      jcrVfsWithAllPrivileges.updateFile(v1, v1.getRevisionId(), true, null, null, false);
   ...
   @Test
   public void test43QueryFileByMetaData()
   {
      IFileInfo fileInfo = new FileInfo("testFindFileByMetaData.txt");
      fileInfo.setProperty("testFindByMetaData", new HashMap<Object, Object>());
   ...
   @Test
   public void test44RemoveVersion()
   {
      ...
      file = jcrVfsWithAllPrivileges.updateFile(file, true, null, null, false);
   ...
   @Test
   public void test45RemoveFile1() throws Exception
   {
   ...
   @Test
   public void test46RemoveFile2() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test47RemoveFolder() throws Exception
   {
      IFolder fNase = jcrVfsWithAllPrivileges.getFolder("/nase");
   ...
   @Test
   public void test48RootFolder() throws Exception
   {
      IFolder rootFolder = jcrVfsWithAllPrivileges.getFolder("/");
   ...
   public void test49SetPolicyForVersionedFile() throws Exception
   {
      ...
      IFile v1 = jcrVfsWithAllPrivileges.createFileVersion(v0.getPath(), null, "v1", false);
   ...
   @Test
   public void test50DeletePermission()
   {
