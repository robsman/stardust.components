 ...
 *
 * Copied from org.apache.jackrabbit.core.security.principal.DefaultPrincipalProvider
 * The differences are in the method providePrincipal() and in constructor
 * (takes UserManager instead of UserManagerImpl)
 */

// TODO maybe inline the contents of AbstractPrincipalProvider to reduce dependencies from Jackrabbit
...
//    private final LRUMap membershipCache;
     ...
     */
    public JcfVfsPrincipalProvider(Session securitySession,
...
//        membershipCache = new LRUMap();
    ...
    protected Principal providePrincipal(String principalName) {
        ...
        try {
            // this is the difference to the PrincipalProvider of Jackrabbit
            // JcrVfsPrincipal is used instead of PrincipalImpl
            Principal principal = new JcrVfsPrincipal(principalName);
...
//        }
     ...
     */
    private class PrincipalIteratorImpl implements PrincipalIterator {

       private Logger log = LoggerFactory.getLogger(PrincipalIteratorImpl.class);
