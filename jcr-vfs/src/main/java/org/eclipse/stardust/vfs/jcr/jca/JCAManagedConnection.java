...
// Copied from org.apache.jackrabbit.jca.JCAManagedConnection.
      ...
      implements ManagedConnection, ManagedConnectionMetaData
{
    ...
    */
   public JCAManagedConnection(JackrabbitRepositoryMCF mcf, JCAConnectionRequestInfo cri) throws ResourceException
   {
      this.mcf = mcf;
      this.cri = cri;
   ...
   public void cleanup() throws ResourceException
   {
      synchronized (handles)
      {
         ...
         this.handles.clear();
         if (this.mcf.getBindSessionToTransaction().booleanValue()
               && (this.xaResource instanceof TransactionBoundXAResource))
         {
    ...
    * handle with a ManagedConneciton instance.
    */
   ...
   void closeHandles()
   {
      synchronized (handles)
      {
         JCASessionHandle[] handlesArray = new JCASessionHandle[handles.size()];
