 ...
 *******************************************************************************/
/*
 * $Id: ContentUploadFailedException.java 54136 2012-02-29 12:33:54Z sven.rottstock $
...
public class ContentUploadFailedException extends RepositoryOperationFailedException
{
   ...
   public ContentUploadFailedException(String message)
   {
      super(message);
   }
   
   public ContentUploadFailedException(Throwable cause)
   {
      super(cause);
   }
   
   public ContentUploadFailedException(String message, Throwable cause)
   {
      super(message, cause);
   }
